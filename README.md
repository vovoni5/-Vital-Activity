...
- **🎨 Кастомизация** – светлая/тёмная тема, акцентный цвет, кастомные шрифты
...
- Тесты репозитория: `CoreDataRecipeRepositoryTests`
- Тесты ViewModels: `RecipesBaseViewModelTests`

### UI-тесты
- Основные сценарии: запуск приложения, создание рецепта, таймер
